...
int main() {
	...
	{
		std::cout << "\n您正在使用过时的程序版本！请到Github网站更新程序的最新版本！\n地址：https://github.com/KarlcxChina/KemonoDownloader\n" << std::endl;
	}
	...
	std::cout << "请输入目标网址（请不要输入“?o=”及之后的部分，否则程序将无法正常识别 Single版请忽略该提示）：" << std::endl;
